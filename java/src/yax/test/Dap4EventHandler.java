...
import static yax.test.Dap4Parser.Lexer.*;
...
public class Dap4EventHandler extends SaxEventHandler
{
    ...
    static {
        ...
        elementmap.put("Value",
            new Lexeme("Value", VALUE_, _VALUE, 0,
    ...
    public Dap4EventHandler(String document, Dap4Parser pushparser)
        throws SAXException
    {
        super(document);
